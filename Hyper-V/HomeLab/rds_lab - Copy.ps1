...
$functionFiles = @("Setup-DomainController.ps1", "Wait-VMReady.ps1", "Join-Domain.ps1", "Set-RDSConfiguration.ps1", "New-VMFromTemplate.ps1", "Configure-VMNetwork.ps1", "Set-VMStaticIP.ps1")
...
$domainadminusername = $config.DomainName + "\" + $config.AdminUsername
...
Set-RDSConfiguration -rdsConfig $rdsConfig -domainCredential $domainadminusername
