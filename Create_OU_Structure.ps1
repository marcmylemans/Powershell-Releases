...
New-ADGroup -Name "SG_APP_servers-administrator" -SamAccountName "SG_APP_servers-administrator" -GroupCategory Security -GroupScope Global -DisplayName "Application Servers Local Administrator" -Path ("OU=Server,OU=Security,OU=Groups,OU=AD-Synced,OU=" + $DomainNetbiosName + "," + $rootOUpath) -Description "Members of this group are Local Administrator on the Application Servers"
