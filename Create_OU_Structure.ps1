...
New-ADGroup -Name "SG_APP_O365_e3" -SamAccountName "SG_APP_O365_e3" -GroupCategory Security -GroupScope Global -DisplayName "Office 365 E3 License" -Path ("OU=Applications,OU=Security,OU=Groups,OU=" + $DomainNetbiosName + "," + $rootOUpath) -Description "Members of this group have a Office 365 E3 License"
New-ADGroup -Name "SG_APP_O365_e1" -SamAccountName "SG_APP_O365_e1" -GroupCategory Security -GroupScope Global -DisplayName "Office 365 E1 License" -Path ("OU=Applications,OU=Security,OU=Groups,OU=" + $DomainNetbiosName + "," + $rootOUpath) -Description "Members of this group have a Office 365 E1 License"
New-ADGroup -Name "SG_APP_O365_Business" -SamAccountName "SG_APP_O365_Business" -GroupCategory Security -GroupScope Global -DisplayName "Office 365 Business Premium License" -Path ("OU=Applications,OU=Security,OU=Groups,OU=" + $DomainNetbiosName + "," + $rootOUpath) -Description "Members of this group have a Office 365 Business Premium License"
New-ADGroup -Name "SG_APP_RDS_Users" -SamAccountName "SG_APP_RDS_Users" -GroupCategory Security -GroupScope Global -DisplayName "RDS Host Users" -Path ("OU=Applications,OU=Security,OU=Groups,OU=" + $DomainNetbiosName + "," + $rootOUpath) -Description "Members of this group can use RDS sessions"

#Computer Based Security Rights

New-ADGroup -Name "SG_computers-administrator" -SamAccountName "SG_computers-administrator" -GroupCategory Security -GroupScope Global -DisplayName "Computers Local Administrator" -Path ("OU=Computers,OU=Security,OU=Groups,OU=" + $DomainNetbiosName + "," + $rootOUpath) -Description "Members of this group are Local Administrator on the Computers"
New-ADGroup -Name "SG_web-servers-administrator" -SamAccountName "SG_web-servers-administrator" -GroupCategory Security -GroupScope Global -DisplayName "Web Servers Local Administrator" -Path ("OU=Servers,OU=Security,OU=Groups,OU=" + $DomainNetbiosName + "," + $rootOUpath) -Description "Members of this group are Local Administrator on the Web Servers"
New-ADGroup -Name "SG_APP_servers-administrator" -SamAccountName "SG_APP_servers-administrator" -GroupCategory Security -GroupScope Global -DisplayName "Application Servers Local Administrator" -Path ("OU=Servers,OU=Security,OU=Groups,OU=" + $DomainNetbiosName + "," + $rootOUpath) -Description "Members of this group are Local Administrator on the Application Servers"
New-ADGroup -Name "SG_db-servers-administrator" -SamAccountName "SG_db-servers-administrator" -GroupCategory Security -GroupScope Global -DisplayName "Database Servers Local Administrator" -Path ("OU=Servers,OU=Security,OU=Groups,OU=" + $DomainNetbiosName + "," + $rootOUpath) -Description "Members of this group are Local Administrator on the Database Servers"
